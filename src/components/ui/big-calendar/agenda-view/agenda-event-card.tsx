...
import { CheckSquare2, Clock, Text, User, Sparkles } from "lucide-react";

import { useCalendar } from "@/components/calendar/calendar-context";

import { EventDetailsDialog } from "@/components/ui/big-calendar/dialogs/event-details-dialog";
      ...
      <div role="button" tabIndex={0} className={agendaEventCardClasses} onKeyDown={handleKeyDown}>
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-1.5">
            ...
            {event.kind === "habit" && <Sparkles className="size-4 shrink-0" />}
